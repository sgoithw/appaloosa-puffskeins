...
`}}var p,q;const f=class f{constructor(){y(this,p)}getExerciseListHTML(e,t){if(!f.exerciseCardType[t])return console.error(`Unsupported exercise card type '${t}' when trying to create exercise card.`),"";let r;return t===f.exerciseCardType.FAVORITES&&(r=`
        ...
        <svg class='move-to-trash-icon' width='16' height='16'>
          ...
          </button>`),e.map(i=>(t===f.exerciseCardType.HOME&&(r=`
        <div class='rating'>
...
//# sourceMappingURL=dayquote-dcb07f42.js.map
